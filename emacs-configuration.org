...
#+begin_src emacs-lisp
  (use-package recentf
    ...
    (add-to-list 'recentf-exclude
             (recentf-expand-file-name "\\.config"))
    (recentf-mode t)
...
#+begin_src emacs-lisp
  ...
  (use-package elfeed-org
    ...
    (elfeed-org)
    :custom
    (rmh-elfeed-org-files (denote-directory-files-matching-regexp "elfeed")))
#+end_src
...
#+begin_src elisp
  (use-package org
    ...
    (org-default-notes-file
     (car (directory-files denote-directory t "inbox")))
    ;; Capture templates
...
#+begin_src elisp
  ...
  (use-package denote
    ...
    (denote-excluded-directories-regexp "financial")
    :hook
    ;; Pretty filenames
...
#+begin_src elisp
  (use-package denote-menu
    ...
    :bind (("C-c d m" . denote-menu-list-notes)
  ...
  (use-package consult-notes
    ...
    (consult-notes-file-dir-sources
     `(("Notes"       ?n ,denote-directory)
       ...
       ("Financial"   ?f ,(concat denote-directory "financial"))
       ("Photos"      ?p "~/Pictures/"))))
#+end_src
...
#+begin_src elisp
  (use-package citar-denote
    ...
    (("C-c d c c" . citar-create-note)
     ...
     ("C-c d c n" . citar-denote-nocite)
     ("C-c d c m" . citar-denote-cite-nocite)))
#+end_src
...
#+begin_src elisp
  ...
  ;; Evaluate
  (define-key prog-mode-map (kbd "C-c C-d") 'eval-buffer)
